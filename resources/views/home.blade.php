...
<div class="row row-eq-height my-3 mt-3">
        ...
        <div class="card-group pt-2 pb-3" >
            <div class="card col-md-3">
                <div class="card-header white">
                        <strong> Weekly Progress by Category</strong>
                    </div>
                <div class="card-body">
                   <div class="my-3">
                        <small>25% - New Converts</small>
                        <div class="progress" style="height: 3px;">
                            <div class="progress-bar bg-success" role="progressbar" style="width: {{count($newconverts) }}%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="my-3">
                        <small>45% - First Timers</small>
                        <div class="progress" style="height: 3px;">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 45%;" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="my-3">
                        <small>60% - Daily Evangelism</small>
                        <div class="progress" style="height: 3px;">
                            <div class="progress-bar bg-warning" role="progressbar" style="width: 60%;" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="my-3">
                        <small>75% - Foundation Class Entrance</small>
                        <div class="progress" style="height: 3px;">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="my-3">
                        <small>57% - DHC Establishment</small>
                        <div class="progress" style="height: 3px;">
            ...
            <div class="card col-md-6">
                <div class="card-header white">
                    <strong> District Weekly Impact</strong> 
                    <!--<span class="float-right"> <a href="{{route('dhc.districts', \Crypt::encrypt(4235) ) }}" class="btn btn-outline-primary btn-xs">View All Districts</a></span>-->
                </div>
                <div class="card-body bg-light slimScroll" data-height="229" style="overflow: hidden; width: auto; height: 100px;">
                    <div class="table-responsive">
                            <table class="table bg-light">
                                ...
                                <thead>
                                    <tr class="no-b">
                                        <th>#</th>
                                        <th style="text-transform: uppercase;">District Names</th>
                                        <th style="text-transform: uppercase; text-align: center;"> Zones</th>
                                        <th style="text-transform: uppercase; text-align: center;"> Areas</th>
                                        <th style="text-transform: uppercase; text-align: center;"> DHC</th>
                                        <th style="text-transform: uppercase; text-align: center;">First Timers</th>
                                        <th style="text-transform: uppercase; text-align: center;">New Converts</th>
                                        <th style="text-transform: uppercase; text-align: center;">Daily Evang.</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ ++$count }}</td>  
                                        <td><a href="{{route('converts.one', \Crypt::encrypt($dist->id)) }}"> <b>{{ strtoupper($dist->dis_name) }}</b></a></td>
                                        ...
                                        <td align="center">{{ number_format(count($dist->getFirstTimers),0) }}</td>
                                        <td align="center">{{ number_format(count($dist->getNewConverts),0) }}</td>
                                        <td align="center">{{ number_format(count($dist->getDailyEvangelism),0) }}</td>
                                    </tr>
                                        @endforeach
            ...
            <div class="card blue lighten-2 border-primary col-md-3" align="center" >
                <div class="p-5 text-white" style="height: 180px;">
                    <h5 class="font-weight-normal s-36 text-uppercase">Members</h5><br>
                    <span class="s-48 bolder font-weight-heavy text-primary">{{ number_format(count($members), 0) }}</span>
                </div>
                 <b style="color: white; font-size: 12px;">********************************************************</b> 
                <div class="row text-white p-2 s-18 text-center">
                    <div class="col-6 b-r text-uppercase"> 
                        New Converts <br>
                        <div>{{ number_format(count($newconverts), 0) }}</div>
                    </div>
                    <div class="col-6 text-uppercase"> 
                        First Timers <br>
                        <div>{{ number_format(count($firsttimers), 0) }}</div>
                    </div>
                </div>
                ...
                <div class="p-5 white">
                    ...
                    <div> Global % 
                        <span class="text-light-green">
                            <i class="icon icon-arrow_downward"></i> 0.20%</span>
                    </div>
                </div>
                </a>
            </div>
                ...
                <div class="p-5 blue lighten-3 text-white">
                    ...
                    <div> Global %
                        <span class="text-primary">
                            <i class="icon icon-arrow_downward"></i> 1.32%</span>
                    </div>
                </div>
                </a>
            </div>
                ...
                <div class="p-5 white">
                    ...
                    <div> Global % 
                        <span class="amber-text">
                            <i class="icon icon-arrow_downward"></i> 3.67%</span>
                    </div>
                </div>
                </a>
            </div>
    ...
    <div class="col-md-6">
    	<div class=" card b-0">
            <div class="card-body p-5 slimScroll" data-height="300"">
