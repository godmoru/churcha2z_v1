@role('administrator|resident-pastor|auditor|hq-accountant')
<div class="tab-pane fade show" id="v-pills-settings" role="tabpanel"
    ...
    <ul class="sidebar-menu">
        @role('administrator')
        <li class="treeview">
            <a href="{{ route('preferences.index', \Crypt::encrypt(23))}}">
        ...
        <li class="treeview"><a href="#"><i class="icon icon-key s-24"></i>Access Controll<i
            ...
            <ul class="treeview-menu">
                ...
                <li><a href=""><i class="icon icon-circle-o"></i>Permissions</a></li>
            </ul>
        </li>
        @endrole
        @role('administrator|resident-pastor|auditor|hq-accountant')
