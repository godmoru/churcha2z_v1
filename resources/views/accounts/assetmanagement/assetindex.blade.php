                ...
                <table id="example2" class="table table-bordered table-hover data-tables" data-options='{ "paging": false; "searching":false}'>
                  <thead>
                    <tr>
                        ...
                        <th width="18%" style="text-align: center; text-transform: uppercase;">Location</th>
                        <th width="20%" style="text-align: left; text-transform: uppercase;">Asset Name</th>
                        <th width="10%" style="text-align: center; text-transform: uppercase;">Category</th>
                        ...
                        <th width="20%" style="text-align: center; text-transform: uppercase;">Status</th>
                        <th> OPTIONS</th>
                        </tr>
                    </thead>
                     <tbody>
                            ...
                            @foreach($assets as $count => $asset)
                                <td>{{ ++$count }}</td>  
                                <td align="">{{ $asset->location->loc_name }}</td>
