    ...
    <div class="col-md-12">
        ...
        <div class=" card b-0">
            <div class="card-header white">
                <i class="icon-home 2x blue-text"></i> <strong class="text-uppercase">Year Capital Expenditure </strong> 
                    ...
                    <tr>
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            @foreach($years as $year)
                            <td align="center" style="font-weight: bold;">
                                {{ number_format(\App\LocationExpenditure::where('year', $year)->where('location_id', \Auth::user()->location_id)->whereBetween('expenditure_type_id', [1,8])->sum('amount'), 2) }}
                            </td>
                            @endforeach
                            <td align="center" style="font-weight: bold;">
                                {{ number_format(\App\LocationExpenditure::whereBetween('year', [date("Y") - 5,date("Y")])->where('location_id', \Auth::user()->location_id)->whereBetween('expenditure_type_id', [1,8])->sum('amount'), 2) }}
                            </td>
