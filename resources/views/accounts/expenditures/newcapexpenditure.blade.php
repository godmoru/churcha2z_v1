    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-uppercase" id="myModalLabel" style="font-weight: bold;">Capital Expenditure</h4>
            </div>
                    ...
                    <tr>
                     ...
                     <tbody>
                            ...
                            @foreach($expTypes as $count => $type)
                                ...
                                <td align="center"><!--  --><input type="number" class="form-control form-control-sm amount" name="amount[]" id="amount" value="0" align="center" style="text-align: center; " onchange="sumup();" onkeyup="sumup();" tabindex="{{++$count}}"/></td>
                            </tr>
                        @endforeach
                        <input name="cap_id" value="1" type="hidden"/>
                        <tr>
