    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-uppercase" id="myModalLabel" style="font-weight: bold;">Capital Expenditure (Uncategorized)</h4>
            </div>
            <div class="modal-body">
                <form role="form" method="POST" action="{{ route('expenditure.submit.uncategorised') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <br>
                            <button type="button" name="add" id="add" class="btn btn-success btn-xs btn-block">Click here to add line item.</button>
                        </div>
                    </div>
                    <div class="row">

                        <div class="col-md-12">
                            <table class="table table-bordered table-hover" id="expUncat" data-options='{ "paging": false; "searching":false}'>
                                  <thead>
                                    <tr>
                                     ...
                                     <tbody>
                                            <tr class="odd gradeX"> 
                                                <input type="hidden" name="expenditure_type_id[]" value="999999999">
