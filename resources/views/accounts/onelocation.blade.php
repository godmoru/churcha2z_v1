...
<header class="white pt-3 relative shadow"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                   ...
                   <div class="col-md-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          @foreach ($months as $key => $month)
                            <td align="right">
                              {{ number_format(( \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('cash') 
                              + \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('pos') 
                              + \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('cheques')), 2) }}
                            </td>
                          @endforeach
                          <td align="right">
                            {{ number_format(( \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('cash') 
                            + \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('pos') 
                            + \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->where('income_report_source_id', $irSource->id)->sum('cheques')), 2) }}
                          </td>
                        </tr>
                        @endforeach
                        <tr>
                          <td width="15%" rowspan="" style="text-transform: uppercase; font-weight: bold">Grand Total</td>
                          @foreach ($months as $key => $month)
                          <td align="right">
                            {{ number_format(( \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('cash') 
                            + \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('pos') 
                            + \App\IncomeReport::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('cheques')), 2) }}
                          </td>
                          @endforeach
                          <td align="right">
                            {{ number_format(( \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('cash') 
                            + \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('pos') 
                            + \App\IncomeReport::where('year', date('Y'))->whereBetween('month', [1,12])->where('location_id', $location->id)->whereBetween('income_report_source_id', [$iRSource[0]->id, $iRSource[count($iRSource) - 1]->id])->sum('cheques')), 2) }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <table id="example2" class="table table-bordered table-hover" data-options='{ "paging": false; "searching":false}'>
                              ...
                              <tbody>
                                 <?php $allCap = array(); ?>
                                  <?php foreach($capexp as $key=>$capex) {?>
                                  
                                  <tr>
                                      
                                      <td width="15%" rowspan="" style="text-transform: uppercase; font-weight: bold">{{$capex->name}}
                                       <?php $allCap[12]= $capex->name;
                                      
                                       ?>
                                      </td>
                                      @foreach ($months as $key => $month )
                                      <td align="right">
                                        <?php $allCap[$key] = \App\LocationExpenditure::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('expenditure_type_id', $capex->id)->sum('amount') ?>
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('expenditure_type_id', $capex->id)->sum('amount') ), 2) }}
                                      </td>
                                      @endforeach
                                      <td align="right">
                                      {{
                                       ...
                                       <td align="right">
                                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modifyCapEx"  aria-labelledby="{{$capex->id}}" aria-hidden="true"
                                            data-jan="<?php echo !empty($allCap[0]) ? $allCap[0] : '' ?>" 
                                            data-feb="<?php echo !empty($allCap[1]) ? $allCap[1] : '' ?>"
                                            data-mar="<?php echo !empty($allCap[2]) ? $allCap[2] : '' ?>"
                                            data-apr="<?php echo !empty($allCap[3]) ? $allCap[3] : '' ?>"
                                            data-may="<?php echo !empty($allCap[4]) ? $allCap[4] : '' ?>"
                                            data-jun="<?php echo !empty($allCap[5]) ? $allCap[5] : '' ?>"
                                            data-jul="<?php echo !empty($allCap[6]) ? $allCap[6] : '' ?>"
                                            data-aug="<?php echo !empty($allCap[7]) ? $allCap[7] : '' ?>"
                                            data-sep="<?php echo !empty($allCap[8]) ? $allCap[8] : '' ?>"
                                            data-oct="<?php echo !empty($allCap[9]) ? $allCap[9] : ''  ?>"
                                            data-nov="<?php echo !empty($allCap[10]) ? $allCap[10] : '' ?>"
                                            data-dec="<?php echo !empty($allCap[11]) ? $allCap[11] : '' ?>"
                                            data-eTitle="<?php echo !empty($allCap[12]) ? $allCap[12] : '' ?>">Modify</button>
                                      </td>
                                 ...
                                 <?php } ?>
                                    <tr>
                                      <td width="15%" rowspan="" style="text-transform: uppercase; font-weight: bold">
                                          Total
                                      </td>
                                      @foreach ($months as $key => $month )
                                     <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', $key)->where('location_id', $location->id)->where('expenditure_category_id', 1)->sum('amount') ), 2) }}
                                      </td>
                                      @endforeach
                                       <td align="right">
                                      {{
                                          number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('location_id', $location->id)->where('expenditure_category_id', 1)->sum('amount')), 2) 
                                      }}
                                      </td>
                                  </tr>
                              </tbody>
                         ...
                         <div class="card-body">
                           <table id="example2" class="table table-bordered table-hover" data-options='{ "paging": false; "searching":false}'>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <td width="15%" rowspan="" style="text-transform: uppercase; font-weight: bold">{{$recex->name}}
                                      <?php $allRecEx[12] =  $recex->name; 
                                     
                                      ?>
                                      </td>
                                      <td align="right">
                                          <?php $allRecEx[0] = \App\LocationExpenditure::where('year', date('Y'))->where('month', 1)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount')  ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[1]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 2)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[2]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 3)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[3]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 4)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[4]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 5)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[5]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 6)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[6]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 7)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[7]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 8)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[8]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 9)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[9]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 10)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[10]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 11)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
                                      ...
                                      <td align="right">
                                          <?php $allRecEx[11]= \App\LocationExpenditure::where('year', date('Y'))->where('month', 12)->where('location_id', $location->id)->where('expenditure_type_id', $recex->id)->sum('amount') ?>
  ...
  <td align="right">
                                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modifyRecEx"  aria-labelledby="{{$recex->id}}" aria-hidden="true"
                                            data-jan="<?php echo $allRecEx[0] ?>" 
                                            data-feb="<?php echo $allRecEx[1] ?>"
                                            data-mar="<?php echo $allRecEx[2] ?>"
                                            data-apr="<?php echo $allRecEx[3] ?>"
                                            data-may="<?php echo $allRecEx[4] ?>"
                                            data-jun="<?php echo $allRecEx[5] ?>"
                                            data-jul="<?php echo $allRecEx[6] ?>"
                                            data-aug="<?php echo $allRecEx[7] ?>"
                                            data-sep="<?php echo $allRecEx[8] ?>"
                                            data-oct="<?php echo $allRecEx[9] ?>"
                                            data-nov="<?php echo $allRecEx[10] ?>"
                                            data-dec="<?php echo $allRecEx[11] ?>"
                                            data-eTitle="<?php echo $allRecEx[12] ?>">Modify </button>
                                      </td>
                                  </tr>
                                  
                                  @endforeach
               </tbody> <tr>
                                      <td width="15%" rowspan="" style="text-transform: uppercase; font-weight: bold">Total</td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 1)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ), 2) }}
                                      </td>

                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 2)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 3)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 4)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 5)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 6)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 7)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 8)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 9)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 10)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 11)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                      <td align="right">
                                          {{ number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('month', 12)->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount') ),2) }}
                                      </td>
                                              

                                      <td align="right">
                                      {{
                                          number_format(( \App\LocationExpenditure::where('year', date('Y'))->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount')), 2) 
                                      }}
                                      </td>
                               ...
                               <div class="card blue lighten-2 border-primary " align="center" >
                                ...
                                <div class="row text-white p-2 s-18 text-center">
                                    <div class="col-6 b-r text-uppercase"> 
                                        Capital <br>
                                        <div> &#8358; {{ number_format((\App\LocationExpenditure::where('year', date("Y"))->where('month', date("m"))->where('location_id', $location->id)->where('expenditure_category_id', 1)->sum('amount')), 2) }}</div>
                                    </div>
                                    
                                    <div class="col-6 text-uppercase"> 
                                        Recurrent <br>
                                        <div> &#8358; {{ number_format((\App\LocationExpenditure::where('year', date("Y"))->where('month', date("m"))->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount')), 2) }}</div>
                                    </div>
                                </div>
                            </div>
                           </div>
                           ...
                           <div class="col-md-6">
                               <div class="card success lighten-2 border-success " align="center" >
                                ...
                                <div class="row text-white p-2 s-18 text-center">
                                    <div class="col-6 b-r text-uppercase"> 
                                        Capital <br>
                                        <div> &#8358; {{ number_format((\App\LocationExpenditure::where('year', date("Y"))->where('location_id', $location->id)->where('expenditure_category_id', 1)->sum('amount')), 2) }}</div>
                                    </div>
                                    
                                    <div class="col-6 text-uppercase"> 
                                        Recurrent <br>
                                        <div> &#8358; {{ number_format((\App\LocationExpenditure::where('year', date("Y"))->where('location_id', $location->id)->where('expenditure_category_id', 2)->sum('amount')), 2) }}</div>
                                    </div>
                                </div>
                            </div>
                           </div>
...
@include('locations.modals.editCapitalExpenditure')
@include('locations.modals.editRecurrentExpenditure')
...
<script type="text/javascript">     
 ...
 $('#modifyCapEx').on('show.bs.modal', function (event) {

      var button = $(event.relatedTarget) 
      var jan = button.data('jan'); 
      var feb = button.data('feb') ;
      var mar = button.data('mar'); 
      var apr = button.data('apr'); 
      var may = button.data('may'); 
      var jun = button.data('jun'); 
      var jul = button.data('jul'); 
      var aug = button.data('aug'); 
      var sep = button.data('sep'); 
      var oct = button.data('oct'); 
      var nov = button.data('nov'); 
      var dec = button.data('dec');
      console.log(button.data('eTitle'));
       var cap = button.data('cap');
      
      var modal = $(this)

      modal.find('.modal-body #jan').val(jan);
      modal.find('.modal-body #feb').val(feb);
      modal.find('.modal-body #mar').val(mar);
      modal.find('.modal-body #apr').val(apr);
      modal.find('.modal-body #may').val(may);
      modal.find('.modal-body #jun').val(jun);
      modal.find('.modal-body #jul').val(jul);
      modal.find('.modal-body #aug').val(aug);
      modal.find('.modal-body #sep').val(sep);
      modal.find('.modal-body #oct').val(oct);
      modal.find('.modal-body #nov').val(nov);
      modal.find('.modal-body #dec').val(dec);
      
      modal.find('.modal-body #editTitle').html(eTitle);
      modal.find('.modal-body #cap').val(cap);
      
});


 $('#modifyRecEx').on('show.bs.modal', function (event) {
      ...
      modal.find('.modal-body #eTitle').html(eTitle);
