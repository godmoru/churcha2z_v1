<div class="modal fade bt-white" id="yearmonthlysummary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-uppercase" id="myModalLabel">Search Year By Month Financial Summary Report</h4>
			</div>
			<div class="modal-body">
				<form role="form" method="POST" action="{{ route('locationgeneralstatement','search') }}">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-md-6">
