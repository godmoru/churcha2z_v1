<div class="modal fade bt-white" id="oexportyear" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-uppercase" id="myModalLabel">Download Year Report</h4>
			</div>
			<div class="modal-body">
				<form role="form" method="POST" action="{{ route('export.get-yearly-reports') }}">
					{{ csrf_field() }}
					<div class="row">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary" class="report">Get Report(s)</button>
				</div>
			</div>
		</div>
	</div>
