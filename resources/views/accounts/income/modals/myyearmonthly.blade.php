<div class="modal fade bt-white" id="myyearmonthly" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-uppercase" id="myModalLabel">Get Desired Year By Month Report</h4>
			</div>
			<div class="modal-body">
				<form role="form" method="POST" action="{{ route('income.post.my-location-monthly-reports') }}">
					{{ csrf_field() }}
					<div class="row">
