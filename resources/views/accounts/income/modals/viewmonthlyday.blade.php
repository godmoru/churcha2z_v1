<div class="modal fade bt-white" id="viewmonthlyday" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" method="POST" action="{{ route('income.post.my-location-daily-reports') }}">
					{{ csrf_field() }}
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label>Day<span class="symbol required"></span></label>
								<select class="custom-select select2" required name="day" id="day">
                                    <option value="">Desired Day</option>
                                    @foreach($days as $day)
