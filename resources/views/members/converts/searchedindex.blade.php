    ...
    <div class="col-md-12">
        ...
        <div class=" card b-0">
            <div class="card-header white">
                <i class="icon-home 2x blue-text"></i> <strong class="text-uppercase"> Converts Query Results </strong> 
                <div class="pull-right" align="right">
                    ...
                    <!-- <a href="{{route('converts.copyphones') }}" class="btn btn-outline-info btn-xs"> <i class="icon-copy"></i> Copy Phone No(s)</a> -->
