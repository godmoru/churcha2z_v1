...
<html>
    ...
    <body> 
        ...
        <img src="{{asset('img/dunamis.png')}}" alt="" style="height: 140px; width: 180px;" align="center">
    </div>
        <p class="h2 " align="center" style="font-family: ">DUNAMIS INTERNATIONAL GOSPEL CENTER</p> 
        <p class=" h4 text-uppercase" align="right"> {{ \Auth::user()->location->loc_name}} First Timers LIST AS AT {{ date('jS M, Y')}}</p>
        ...
        <table id="example2" class="table table-bordered table-hover data-tables" data-options='{ "paging": false; "searching":false}'>
          <thead>
            <tr>
                ...
                <th width="15%" style="text-transform: uppercase;"> Phone No</th>
                <th width="5%" style="text-transform: uppercase;">SVC</th>
                <th width="15%" style="text-transform: uppercase; text-align: center;">Found. Class</th>
                <th style="text-transform: uppercase; text-align: center;">DLTC</th>
