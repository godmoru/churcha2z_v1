<div class="card my-3 col-md-12">
    <div class="card-body">
        <h4 class="text-center text-uppercase">Filter members</h4> <hr><br>
        <form class="form-material" action="{{ route('members.new') }}" method="POST">
           ...
           <!--  <div class="row clearfix">
            ...
            <div class="jumbotron">
                <h4 class="text-uppercase text-center"> This feature is disabled for this version of the application. You may please consult with the super administrator to enable this feature for you, thank you.</h4>
            </div>
