                    ...
                    <div class="pb-3">
                        <div>
                            <h3 class="p-t-10 text-center text-bold"><i class="icon-cube"></i> <strong>{{$batchname->name}}</strong></h3>
                              <!-- <br> -->
                              <a data-toggle="modal" data-target="#editClass" class="btn btn-warning btn-xs btn-block disabled"><i class="icon-clipboard-edit"></i> Edit Class Info</a>
                                    ...
                                    {{ csrf_field() }}
                                      <table id="example2" class="table table-bordered table-hover" data-options='{ "paging": false; "searching":false}'>
                                          <thead>
                                           ...
                                           <tbody>
                                              @foreach($batchname->participants as $count => $class)
                                              <tr>
                                                  <td>{{ ++$count }}</td>  
                                                  <td><a href="{{route('converts.one', \Crypt::encrypt($class->people->id)) }}"> <b>{{ $class->people->fullnames }}</b></a></td>
                                                  <td>{{ $class->people->phone1 }}</td>
                                                  <!-- <td>{{date_format($class->people->created_at, "jS F, Y")}}</td>   -->
                                                  <!-- <td align="center">{{ isset($class->participants) ? number_format(count($class->participants),0) : " 2"}}</td> -->
                                                   @role('counselor-hod|fc-coordinator|administrator|resident-pastor|senior-pastor|fd-supervisor')
                                                   <td>
                                                      <center>
                                                          @if($class->class_1_status == 1)
                                                          <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>
                                                          <!-- <input type="hidden" name="class_1_status[]" value="{{$class->id}}"> -->
                                                          @else
                                                          <input type="checkbox" name="class_1_status[]" value="{{$class->id}}" id="selectedChk"/>
                                                          @endif
                                                      </center>
                                                  </td>
                                                  <td>
                                                      <center>
                                                          ...
                                                          <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>
                                                          <input type="hidden" name="class_2_status[]" value="{{$class->id}}">
                                                          @else
                                                          <input type="checkbox" name="class_2_status[]" value="{{$class->id}}" id="selectedChk"/>
                                                          @endif
                                                      </center>
                                                  </td>
                                                  ...
                                                  <td>
                                                      <center>
                                                          ...
                                                          <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>
                                                          <input type="hidden" name="class_3_status[]" value="{{$class->id}}">
                                                          @else
                                                          <input type="checkbox" name="class_3_status[]" value="{{$class->id}}" id="selectedChk"/>
                                                          @endif
                                                      </center>
                                                  </td>
                                                  <td>
                                                      <center>
                                                          ...
                                                          <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>
                                                          <input type="hidden" name="class_4_status[]" value="{{$class->id}}">

                                                          @else
                                                          <input type="checkbox" name="class_4_status[]" value="{{$class->id}}" id="selectedChk"/>
                                                          @endif
                                                      </center>
                                                  </td>
                                                  <td>
                                                      <center>
                                                          ...
                                                          <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>
                                                          <input type="hidden" name="class_5_status[]" value="{{$class->id}}">
                                                          @else
                                                          <input type="checkbox" name="class_5_status[]" value="{{$class->id}}" id="selectedChk"/>
                                                          @endif
                                                      </center>
                                                  </td>
                                                  <!--<td>-->
                                                  ...
                                                  <!--        <input type="checkbox" checked disabled="" value="{{$class->id}}" id="selectedChk"/>-->
                                                  <!--        <input type="hidden" name="class_6_status[]" value="{{$class->id}}">-->
                                                  <!--        @else-->
                                                  <!--        <input type="checkbox" name="class_6_status[]" value="{{$class->id}}" id="selectedChk"/>-->
                                                  <!--        @endif-->
                                                  <!--    </center>-->
                                                  <!--</td>-->
                                                  ...
                                                  <!-- <td>{{ isset($class->counselor) ? $class->counselor->sur_name : " In class participating"}}</td> -->
                                              </tr>
