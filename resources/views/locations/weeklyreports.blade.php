        ...
        <div class=" card b-0">
            ...
            <div class="card-body">
				...
				<table id="example2" class="table table-bordered table-hover" data-options='{ "paging": false; "searching":false}'>
					<thead>
						<tr>
							<th colspan="27" width="20%" style="text-align: center; text-transform: uppercase; font-weight: bold;" >Weekly Report</th>
						</tr>
						<tr>
							<td colspan="2" style="text-align: left; text-transform: uppercase; font-weight: bold;">Branch Name</td>
							<td colspan="12" style="text-align: left; text-transform: uppercase; font-weight: bold;">{{ \App\Location::find(1)->loc_name}}</td>
						...
						<tr>
							<td colspan="2" style="text-align: left; text-transform: uppercase; font-weight: bold;">Branch Pastor</td>
							<td colspan="12" style="text-align: left; text-transform: uppercase; font-weight: bold;">{{   isset(\App\Location::find(1)->get_loc_pst) ? \App\Location::find(1)->get_loc_pst->surname : "Not Set"}}</td>
							<td colspan="13" style="text-align: left; text-transform: uppercase; font-weight: bold;">Period: &emsp; {{ date('F, Y')}}</td>
					...
					<tbody>
						<tr>
							<td rowspan="4" style="text-transform: uppercase; font-weight: bold">Sunday</td>
							<td style="text-transform: uppercase; font-weight: bold">ATT</td>
						...
						<tr>
							...
							<td align="center" colspan="2" style="font-weight: bold; text-transform: uppercase;">OffR<br>
								{{
						...
						<tr>
							<td style="text-transform: uppercase; font-weight: bold">msg Title</td>
						...
						<tr>
							<td style="text-transform: uppercase; font-weight: bold">Preacher</td>
							<td colspan="4">
								@php
						...
						<!-- End Sunday Services -->
						<tr>
							<td rowspan="4" style="text-transform: uppercase; font-weight: bold">Wed.</td>
							<td style="text-transform: uppercase; font-weight: bold">ATT</td>
						...
						<tr>
							...
							<td align="center"> <!-- Monthly Wednesday Income Average-->
