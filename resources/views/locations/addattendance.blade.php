                    ...
                    <table class="table table-bordered table-hover" id="humanCount">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">
                                    <input type="number" class="form-control form-control-sm add male" name="male[]" id="male" value="0" align="center" onkeyup="calculateSum()" onchange="sumup()" style="text-align: center; " />
                                </td>
                                <td align="center">
                                    <input type="number" class="form-control form-control-sm add female" name="female[]" id="female" value="0" align="center" onkeyup="calculateSum()" onchange="sumup()" style="text-align: center; " />
                                </td>
                                <td align="center">
                                    <input type="number" class="form-control form-control-sm add children" name="children[]" id="children" value="0" align="center" onkeyup="calculateSum()" onchange="sumup()" style="text-align: center; " />
                                </td>                                    
                                <td>
                                    <div class="form-group form-float form-group-sm">
                                        <input type="text" class="form-control total" name="total" id="total" readonly onchange="calculateSum()" value="0"  align="center"  style="text-align: center; font-weight: bolder; font-size: 14px;"/>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
