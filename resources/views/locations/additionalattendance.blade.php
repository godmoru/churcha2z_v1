...
<div class="row row-eq-height my-3 mt-3 col-md-12">
    ...
    <div class="card my-3 col-md-12">
        ...
        <form class="form-material" action="{{ route('location.submitAttendance') }}" method="POST">
            {{ csrf_field() }}
            <input type="hidden" name="count_area_classification" value="6">
            <div class="row clearfix">
                ...
                <h5 class="text-uppercase text-center">Human Attendance</h5>
                    <table class="table table-bordered table-hover" id="humanCount">
                        ...
                        <tbody>
                            <tr>
                                <td rowspan="{{$countareas->count()}}">Additional Attendance</td>
                              @foreach($countareas as $carea)
                                ...
                                <td>
                                    <!-- <div class="form-group form-float form-group-sm"> -->
                                        <input type="text" class="form-control total" name="total" id="total"  readonly="" value="0"  align="center"  style="text-align: center; font-weight: bolder; font-size: 14px;"/>
                                    <!-- </div> -->
                                </td>
                            </tr>
                            @endforeach
