<div class="modal fade bt-white" id="editAttRecord" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form  class="form-material" role="form" method="POST" action="{{ route('locations.attdata.update', 'do-update') }}">
      				{{method_field('patch')}}
					{{ csrf_field() }}
					<div class="row ">
