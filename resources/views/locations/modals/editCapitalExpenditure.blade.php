...
<div class="modal fade" id="modifyCapEx" tabindex="-1" role="dialog" aria-labelledby="{{$capex->id}}" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title text-uppercase" id="myModalLabel">Edit Capital Expenditure</h4>
			</div>
