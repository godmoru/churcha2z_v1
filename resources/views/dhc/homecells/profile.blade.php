    ...
    <div class="container-fluid">
        <div class="row p-t-b-12 col-md-12 col-lg-12 ">
            <div class="col-lg-2">
                <div class="pb-3">
                    <div>
                        <h3 class="p-t-10 text-center text-bold"><i class="icon-home2"></i> <strong>{{ $homecell->homecell_name }}</strong> <br> {{ $homecell->seek_code }}</h3>
                          <!-- <br> -->
                          <a data-toggle="modal" data-target="#assignC" class="btn btn-primary btn-xs btn-block"><i class="icon-assignment_ind"></i> Assign Home Cell Leader</a>
                          <a data-toggle="collapse" data-target="#deleteclass" aria-expanded="false" aria-controls="collapseExample" class="btn btn-danger btn-xs btn-block"><i class="icon-trash"></i> Disable/Delete Homecell</a>
                      </div>
                    </div>
                </div>
                <div class="col-lg-10">
                   ...
                   <div class="row no-gutters">
                    ...
                    <div class="col-md-3">
                        <div class="p-3  green lighten-3 text-white">
                            <h5 class="font-weight-normal s-14 text-white">Members in Foundation Class</h5>
                   ...
                   <div class="card ">
                    ...
                    <br>
                       <ul class="list-group list-group-flush">
                           <li class="list-group-item"><i class="icon icon-user text-primary"></i><strong class="s-12">Full Names</strong> <span class="float-right s-12">{{ isset($homecell->counselor) ? $homecell->counselor->surname.' '.$homecell->counselor->othernames : " Not set"}}</span></li>
                           <li class="list-group-item"><i class="icon icon-phone text-primary"></i><strong class="s-12">Phone</strong> <span class="float-right s-12">{{ isset($homecell->counselor) ? $homecell->counselor->phone1 : " Not set"}}</span></li>
                           <li class="list-group-item"><i class="icon icon-envelope text-primary"></i><strong class="s-12">Email</strong> <span class="float-right s-12">{{ isset($homecell->counselor) ? $homecell->counselor->email : " Not set"}}</span></li>
                       </ul>
                   </div>
                   <br>
                     <div class="card">
               ...
               <div class="col-md-9">  
                  <div class="row">
                      <div class="col-md-12">
                           <div class="card">
                               <div class="card-header white">
                                  <h4 class="text-center text-uppercase">Home Church Information Center</h4> <hr>
                               </div>
                               <div class="card-body">
