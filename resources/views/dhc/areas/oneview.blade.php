    ...
    <div class="container-fluid">
        <div class="row p-t-b-12 col-md-12 col-lg-12 ">
            <div class="col-lg-2">
                <div class="pb-3">
                    <div>
                        <h3 class="p-t-10 text-center text-bold"><i class="icon-home2"></i> <strong>{{$area->name}}</strong></h3>
                          <!-- <br> -->
                          <a data-toggle="modal" data-target="#NewCell" class="btn btn-warning btn-xs btn-block"><i class="icon-clipboard-edit"></i> Add New Home Cell</a>
                          ...
                          <a data-toggle="collapse" data-target="#deleteclass" aria-expanded="false" aria-controls="collapseExample" class="btn btn-danger btn-xs btn-block"><i class="icon-trash"></i> Disable/Delete Area</a>
                      </div>
                    </div>
                </div>
                <div class="col-lg-10">
                   ...
                   <div class="row no-gutters">
                    <div class="col-md-3">
                        <div class="p-3 blue1 text-white">
                            ...
                            <span class="s-48 font-weight-lighter text-primary bolder"> {{ number_format(455, 0) }} </span>
                            <div>  Growth %
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="p-3 blue lighten-3 text-white">
                            ...
                            <span class="s-48 font-weight-lighter text-white bolder">{{ number_format(43, 0) }}</span>
                            <div> Global %
                    ...
                    <div class="col-md-2">
                        <div class="p-3 blue lighten-4 text-white">
                            ...
                            <span class="s-48 font-weight-lighter text-white bolder">{{ number_format(343, 0) }}</span>
                            <div> Global % 
                                <span class="text-white">
                                    <i class="icon icon-arrow_downward"></i> 0 %</span>
                   ...
                   <div class="card ">
                    ...
                    <br>
                       <ul class="list-group list-group-flush">
                           <li class="list-group-item"><i class="icon icon-user text-primary"></i><strong class="s-12">Full Names</strong> <span class="float-right s-12">{{ isset($area->counselor) ? $area->counselor->surname.' '.$area->counselor->othernames : " Not set"}}</span></li>
                           <li class="list-group-item"><i class="icon icon-phone text-primary"></i><strong class="s-12">Phone</strong> <span class="float-right s-12">{{ isset($area->counselor) ? $area->counselor->phone1 : " Not set"}}</span></li>
                           <li class="list-group-item"><i class="icon icon-envelope text-primary"></i><strong class="s-12">Email</strong> <span class="float-right s-12">{{ isset($area->counselor) ? $area->counselor->email : " Not set"}}</span></li>
                           <!-- <li class="list-group-item"><i class="icon icon-account_balance text-primary"></i><strong class="s-12">Address</strong> <span class="float-right s-12">{{$area->loc_add}}</span></li> -->
                       </ul>
                   </div>
                   <br>
                     <div class="card">
               ...
               <div class="col-md-9">  
                  <div class="row">
                      <div class="col-md-12">
                           <div class="card">
                               <div class="card-header white">
                                  <h4 class="text-center text-uppercase">Area Information Center</h4> <hr>
                               </div>
                               <div class="card-body">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <thead>
                     ...
                     <tbody>
                        <tr class="odd gradeX">
                        @foreach($area->getHomeCells as $count => $dhc)
                        <td>{{ ++$count }}</td>  
                        <td><a href="{{route('dhc.homecell.one', \Crypt::encrypt($dhc->id)) }}"> <b>{{ strtoupper($dhc->homecell_name) }}</b></a></td>
...
@include('dhc.areas.modals.newcell')
