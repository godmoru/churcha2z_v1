...
<html>
    ...
    <body> 
        ...
        <p class=" h6 text-uppercase" align="center"> {{ \Auth::user()->location->loc_name.' - '.$district->dis_name .' DISTRICT CONVERTS LIST BEtween' . $district->dis_name.' - ' .$district->dis_name}}</p>
