...
<header class="white pt-3 relative shadow">
        <div class="container-fluid">
            <div class="row p-t-b-12 col-md-12 col-lg-12 ">
                <div class="col-lg-2">
                    <div class="pb-3">
                        <div>
                            <h3 class="p-t-10 text-center text-bold"><i class="icon-home2"></i> <strong>{{$zone->zone_name}}</strong></h3>
                              <!-- <br> -->
                              <a data-toggle="modal" data-target="#NewArea" class="btn btn-warning btn-xs btn-block"><i class="icon-clipboard-edit"></i> Add New Area</a>
                              <a data-toggle="modal" data-target="#assignC" class="btn btn-primary btn-xs btn-block"><i class="icon-assignment_ind"></i> Assign Leader</a>
                              <a data-toggle="collapse" data-target="#deleteclass" aria-expanded="false" aria-controls="collapseExample" class="btn btn-danger btn-xs btn-block"><i class="icon-trash"></i> Disable/Delete Zone</a>
                          </div>
                        </div>
                    </div>
                    <div class="col-lg-10">
                       ...
                       <div class="row no-gutters">
                        <div class="col-md-4">
                            <div class="p-3 blue1 text-white">
                                ...
                                <span class="s-48 font-weight-lighter text-primary bolder"> {{ number_format($zone->getFirstTimers + $zone->getNewConverts, 0) }} </span>
                                <div>  Growth %
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="p-3 blue lighten-3 text-white">
                                ...
                                <span class="s-48 font-weight-lighter text-white bolder">{{ number_format($zone->getNewConverts, 0) }}</span>
                                <div> Global %
                        ...
                        <div class="col-md-4">
                            <div class="p-3 blue lighten-4 text-white">
                                ...
                                <span class="s-48 font-weight-lighter text-white bolder">{{ number_format($zone->getFirstTimers, 0) }}</span>
                                <div> Global % 
                                    <span class="text-white">
                                        <i class="icon icon-arrow_downward"></i> 0 %</span>
          ...
          <div class="w">
              <ul class="nav nav-material responsive-tab" id="v-pills-tab" role="tablist">
                  ...
                  <li>
                      <a class="nav-link" id="v-pills-attendance-tab" data-toggle="pill" href="#v-pills-offerings" role="tab" aria-controls="v-pills-attendance" aria-selected="false"><i class="icon icon-money"></i>Offering Chart</a>
                  </li>
  ...
  <div class="container-fluid animatedParent animateOnce my-3">
                       ...
                       <div class="card ">
                        ...
                        <br>
                           <ul class="list-group list-group-flush">
                               <li class="list-group-item"><i class="icon icon-user text-primary"></i><strong class="s-12">Full Names</strong> <span class="float-right s-12">{{ isset($zone->counselor) ? $zone->counselor->surname.' '.$zone->counselor->othernames : " Not set"}}</span></li>
                               <li class="list-group-item"><i class="icon icon-phone text-primary"></i><strong class="s-12">Phone</strong> <span class="float-right s-12">{{ isset($zone->counselor) ? $zone->counselor->phone1 : " Not set"}}</span></li>
                               <li class="list-group-item"><i class="icon icon-envelope text-primary"></i><strong class="s-12">Email</strong> <span class="float-right s-12">{{ isset($zone->counselor) ? $zone->counselor->email : " Not set"}}</span></li>
                               <!-- <li class="list-group-item"><i class="icon icon-account_balance text-primary"></i><strong class="s-12">Address</strong> <span class="float-right s-12">{{$zone->loc_add}}</span></li> -->
                           </ul>
                       </div>
                       <br>
                         <div class="card">
                   ...
                   <div class="col-md-9">  
                      <div class="row">
                          <div class="col-md-12">
                               <div class="card">
                                   <div class="card-header white">
                                      <h4 class="text-center text-uppercase">Zonal Information Center</h4> <hr>
                                   </div>
                                   <div class="card-body">
            ...
            <div class="col-md-12">  
              <div class="row">
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header white">
                        <h4 class="text-center text-uppercase">Zone Areas</h4> <hr>
                      </div>
                      <div class="card-body">
                        ...
                        <thead>
                         ...
                         <tbody>
                            ...
                            <td>{{ ++$count }}</td>  
                            <td><a href="{{route('dhc.area.one', \Crypt::encrypt($area->id)) }}"> <b>{{ strtoupper($area->name) }}</b></a></td>
                            <td align="">{{ $area->name}}</td>
                            <td align="">{{ $area->name}}</td>
                            <td align="center">{{ number_format($area->getHomeCells->count(),0) }} </td>
                            <td align="center">{{ number_format($area->getHomeCells->count(),0) }} </td>
                            <td align="center">{{ number_format($area->getHomeCells->count(),0) }} </td>
                            <td align="center">{{ number_format($area->getHomeCells->count(),0) }} </td>
                            <td align="center">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <thead>
                         ...
                         <tbody>
                            <tr class="odd gradeX">
                            @foreach($zone->getHomeCells as $count => $dhc)
                            <td>{{ ++$count }}</td>  
                            ...
                            <td align="center">{{ number_format(count($dhc->getmembers) + count($dhc->geconverts),0) }} </td>
                            <td align="center">
                              @if($dhc->status == 1)
                              <span class="badge badge-success"><span class="blink"><i class="icon icon-circle mr-2"></i>Active</span></span>
                              @else
   ...
   @include('dhc.zones.modals.newarea')
